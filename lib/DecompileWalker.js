...
class DecompileWalker extends CodeDecompiler {
     ...
     */
    #noteJump(n) {
        console.log(`-- JP      ${this.addr(this.#startPoint + this.loadPoint)} -> ${this.addr(n)}`)
    }
    ...
    #noteRelJump(n) {
        ...
        console.log(`-- JR${this.rel(n + 2).padStart(5, " ")} ${this.addr(this.#startPoint + this.loadPoint)} -> ${this.addr(address)}`)
    }
