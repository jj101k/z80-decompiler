...
class DecompileWalker extends CodeDecompiler {
    ...
    decode() {
        ...
        try {
            ...
            this.#seen.set(this.#startPoint, ["(bad)", this.dw.offset - this.#startPoint])
    ...
    *dump() {
        ...
        for(const startPoint of startPoints) {
            ...
            if(this.#jumps[startPoint + this.loadPoint]) {
                yield `j${this.#jumps[startPoint + this.loadPoint].id.toString(16).padEnd(6, " ")} ${n}`.padEnd(40, " ") + `; ${bytes}`
            } else {
                yield `        ${n}`.padEnd(40, " ") + `; ${bytes}`
            }
