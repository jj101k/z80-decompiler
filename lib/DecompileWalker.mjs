...
export class DecompileWalker extends CodeDecompiler {
    ...
    /**
     * @type {MachineStateView<import("./Z80Registers.d.mts").Z80Registers16B>}
     */
    get s16() {
        return new MachineStateView(this.state, 16)
    }

    /**
     * @type {MachineStateView<import("./Z80Registers.d.mts").Z80Registers8B>}
     */
    get s8() {
        return new MachineStateView(this.state, 1)
    }
