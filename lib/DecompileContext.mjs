...
export class DecompileContext extends CodeDecompiler {
    ...
    /**
     * @type {Map<number, [import("./InstructionHandler/DecomposedInstruction.mjs").DecomposedInstruction | undefined, number]>}
     */
    #seen = new Map()
    ...
    /**
     *
     * @returns {import("./InstructionHandler/DecomposedInstruction.mjs").DecomposedInstruction | null | undefined}
     */
    decode() {
