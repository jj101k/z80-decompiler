import { DecomposedMemoryRegisterInstruction } from "../DecomposedInstruction/DecomposedMemoryRegisterInstruction.mjs"
...
export class UpdateRegisterInstructionHandler extends VariableWidthInstructionHandler {
     ...
     */
    get(dw, context) {
        const di = new DecomposedMemoryRegisterInstruction(this.name, dw, context.volatileState.startPoint)
