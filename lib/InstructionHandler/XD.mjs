...
/**
 * @abstract
 * @template {import("../Z80Registers.d.mts").Z80Registers} R
 */
        ...
        switch (nnx.pre) {
            ...
            case 2: { // 0x8-b
                if (this.isFromMemory(nnx)) { // 0x?e, 0x?6
                    ...
                    context.storeRegisterValue(Z80Registers.A, context.getOpResult(op, context.getRegisterValue(Z80Registers.A),
