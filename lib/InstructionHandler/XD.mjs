        ...
        switch (nnx.pre) {
            ...
            case 1: { // 0x4-7
                if ((register = this.sourceRegister(nnx))) {
                    ...
                    return new ImportRegisterInstructionHandler(`LD ${register}, (${this.offsetRegister}+d)`, register).resolve(dw, context)
                }
                break
            }
            case 2: { // 0x8-b
                if (this.isFromMemory(nnx)) { // 0x?e, 0x?6
                    ...
                    return new DecomposedInstruction(`${op.name} (${this.offsetRegister}+d)`, dw)
                }
                break
            }
            case 3: { // 0x.d c-f
