    ...
    get simpleOpcodes() {
        return {
            ...
            [0x23]: new TrivialInstructionHandler(`INC ${this.offsetRegister}`).withAction((dw, context) => {
                const v = context.getRegisterValue(this.offsetRegister)
                if(v !== null) {
                    context.storeRegisterValue(this.offsetRegister, v + 1)
                }
            }),
        ...
        switch (nnx.pre) {
            ...
            case 2: { // 0x8-b
                if (this.isFromMemory(nnx)) { // 0x?e, 0x?6
                    ...
                    context.updateRegisterValue(Z80Registers8B.A, op, context.getIndirectMemoryValue(
