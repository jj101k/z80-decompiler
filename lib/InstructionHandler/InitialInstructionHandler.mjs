...
export class InitialInstructionHandler extends IncompleteInstructionHandler {
    ...
    get simpleOpcodes() {
        return {
            ...
            [0x02]: new AdHocParsingInstructionHandler("LD (BC), A", (dw, context) => {
                context.s8.storeIndirectMemoryValue(Z80Registers16b.BC, context.s8.getRegisterValue(Z80Registers8b.A))
            }),
            [0x07]: new AdHocParsingInstructionHandler("RLCA", (dw, context) => {
            ...
            [0x08]: new AdHocParsingInstructionHandler("EX AF, AF'", (dw, context) => {
            ...
            [0x0f]: new AdHocParsingInstructionHandler("RRCA", (dw, context) => {
                const v = context.s8.getRegisterValue(Z80Registers8b.A)
            ...
            [0x36]: new AdHocParsingInstructionHandler("LD (HL), n", (dw, context, di) => {
            ...
            [0xc9]: new AdHocParsingInstructionHandler("RET", (dw, context) => {
            ...
            [0xdb]: new AdHocParsingInstructionHandler("IN A, (n)", (dw, context) => {
                // Not known
                context.s8.storeRegisterValue(Z80Registers8b.A, null)
            }),
            [0xdd]: new DDInstructionHandler(),
            [0xe1]: new ImportRegisterInstructionHandler("POP HL", Z80Registers16b.HL),
            [0xe3]: new AdHocParsingInstructionHandler("EX (SP), HL", (dw, context) => {
            ...
            [0xe9]: new AdHocParsingInstructionHandler("JP (HL)", (dw, context) => {
                context.addJumpToHL()
            }),
            [0xeb]: new AdHocParsingInstructionHandler("EX DE, HL", (dw, context) => {
        ...
        switch(n.pre) {
            case 0b00: { // 0x0-0x3
                ...
                if(n.b4 == 0b0001) { // 0x01 11 [21] 31
                    ...
                    if(r == "(HL)") {
                        return new AdHocParsingInstructionHandler(`${op} ${r}`, (dw, context) => {
                            context.s8.updateIndirectMemoryValue(Z80Registers16b.HL,
                                v => (op === "INC") ? AnyExpression.add(v, 1) : AnyExpression.subtract(v, 1))
                        })
                    } else {
                        return new AdHocParsingInstructionHandler(`${op} ${r}`, (dw, context) => {
                    ...
                    switch(n.b4) {
                        case 0b0011: { // INC
                            return new AdHocParsingInstructionHandler(`INC ${rp}`, (dw, context) => {
                                const v = context.s16.getRegisterValue(rp)
                                context.s16.storeRegisterValue(rp, AnyExpression.add(v, 1))
                            })
                        }
                        case 0b1011: { // DEC
                            return new AdHocParsingInstructionHandler(`DEC ${rp}`, (dw, context) => {
                                const v = context.s16.getRegisterValue(rp)
            ...
            case 0b01: { // 0x4-0x7
                if((register = this.targetRegister(n))) {
                    ...
                    const r = register
                    return new AdHocParsingInstructionHandler(`LD (HL), ${r}`, (dw, context) => {
            ...
            case 0b10: { // 0x8-0xb
                ...
                if(r == "(HL)") {
                    return new AdHocParsingInstructionHandler(`${op.name} ${r}`, (dw, context) => {
            ...
            case 0b11: { // 0xc-0xf
                if(n.b4 == 0b0001 && n.a2 != hlR) { // 0xc1, d1, [e1], f1
                    ...
                    return new AdHocParsingInstructionHandler(`PUSH ${rpR[n.a2]}`, () => {
                        // No op, currently
                    })
                }
                const fR = {
                ...
                switch(n.b3) {
                    ...
                    case 0b010: {
                        return new AdHocParsingInstructionHandler(`JP ${fR[n.a3]} a`, (dw, context, di) => {
                            context.addTarget(di.arguments[0])
                        })
                    }
                    case 0b100: {
                        return new AdHocParsingInstructionHandler(`CALL ${fR[n.a3]} a`, (dw, context, di) => {
                    ...
                    case 0b110: {
                        ...
                        const op = arOpR[n.a3]
                        return new AdHocParsingInstructionHandler(`${op.name} n`, (dw, context, di) => {
