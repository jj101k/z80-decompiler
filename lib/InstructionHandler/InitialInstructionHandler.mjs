 ...
 */
export class InitialInstructionHandler extends InstructionHandler {
    /**
    ...
    get simpleOpcodes() {
        return {
            ...
            [0x36]: new TrivialInstructionHandler("LD (HL), n").withAction((dw, context, di) => {
    ...
    get(dw, context) {
        ...
        switch(n.pre) {
            case 0b00: { // 0x0-0x3
                const r = addHlIxIy(n, Z80Registers16b.HL, context)
                if(r) {
                    return r
                }
