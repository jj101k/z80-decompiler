...
export class ED extends InstructionHandler {
    ...
    get simpleOpcodes() {
        return {
            ...
            [0x47]: new CopyRegisterInstructionHandler("I", "A"),
            [0x4f]: new CopyRegisterInstructionHandler("R", "A"),
            [0x57]: new CopyRegisterInstructionHandler("A", "I"),
            [0x5f]: new CopyRegisterInstructionHandler("A", "R"),
