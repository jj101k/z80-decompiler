...
export class ED extends InstructionHandler {
    ...
    get simpleOpcodes() {
        return {
            ...
            [0x47]: new CopyRegisterInstructionHandler(Z80Registers.I, Z80Registers.A),
            [0x4f]: new CopyRegisterInstructionHandler(Z80Registers.R, Z80Registers.A),
            [0x57]: new CopyRegisterInstructionHandler(Z80Registers.A, Z80Registers.I),
            [0x5f]: new CopyRegisterInstructionHandler(Z80Registers.A, Z80Registers.R),
        ...
        switch(nnx.pre) {
            case 0x01: { // 0x4-0x7
                if(nnx.b3 == 0b010) {
                    ...
                    // 16-bit load
                    const rp = rpR[nnx.a2]
                    return new SaveInstructionHandler(`LD (a), ${rp}`).resolve(dw, context)
