...
export class ED extends InstructionHandler {
    ...
    get simpleOpcodes() {
        return {
            ...
            [0x47]: new CopyRegisterInstructionHandler("LD I, A", "I", "A"),
            [0x4f]: new CopyRegisterInstructionHandler("LD R, A", "R", "A"),
            [0x57]: new CopyRegisterInstructionHandler("LD A, I", "A", "I"),
            [0x5f]: new CopyRegisterInstructionHandler("LD A, R", "A", "R"),
