...
export class EDInstructionHandler extends IncompleteInstructionHandler {
    ...
    get simpleOpcodes() {
        return {
            [0x44]: new AdHocParsingInstructionHandler("NEG", (context) => {
            ...
            [0xb0]: new AdHocParsingInstructionHandler("LDIR", (context) => {
            ...
            [0xb8]: new AdHocParsingInstructionHandler("LDDR", (context) => {
                // Immediately not so trivial
                let de = context.s16.getRegisterValue(Z80Registers16b.DE)
                let hl = context.s16.getRegisterValue(Z80Registers16b.HL)
                let bc = context.s16.getRegisterValue(Z80Registers16b.BC)
        ...
        switch(n.pre) {
            case 0x01: { // 0x4-0x7
                if(n.b3 == 0b010) {
                    ...
                    const rp = rpR[rpRef]
                    if(op == "ADC") {
                        return new AdHocParsingInstructionHandler(`${op} HL, ${rp}`, (context) => {
