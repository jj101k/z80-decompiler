        ...
        return {
            ...
            [0xb0]: new AdHocParsingInstructionHandler("LDIR", (dw, context) => {
                ...
                if(!Utilities.isNumber(bc)) {
                    context.s16.storeRegisterValue(Z80Registers16b.HL, AnyExpression.add(hl, bc))
                    context.s16.storeRegisterValue(Z80Registers16b.DE, AnyExpression.add(de, bc))
                } else {
                    bc = bc || 65536
                ...
                if(n.b3 == 0b010) {
                    ...
                    if(op == "ADC") {
                        return new AdHocParsingInstructionHandler(`${op} HL, ${rp}`, (dw, context) => {
                            ...
                            context.s16.storeRegisterValue(Z80Registers16b.HL, AnyExpression.add(a, b))
                        })
                    } else {
                        return new AdHocParsingInstructionHandler(`${op} HL, ${rp}`, (dw, context) => {
                            const a = context.s16.getRegisterValue(Z80Registers16b.HL)
