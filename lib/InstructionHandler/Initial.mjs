...
import { Update8BitRegisterInstructionHandler } from "./Update8BitRegisterInstructionHandler.mjs"
...
export class Initial extends InstructionHandler {
    ...
    get simpleOpcodes() {
        return {
            ...
            [0x21]: new Update16BitRegisterInstructionHandler("LD HL, nn", "HL"),
            ...
            [0x31]: new Update16BitRegisterInstructionHandler("LD SP, nn", "SP"),
        ...
        switch(n.pre) {
            case 0b00: { // 0x0-0x3
                ...
                if(n.b4 == 0b0001) { // 0x01 11 [21] 31
                    ...
                    return new Update16BitRegisterInstructionHandler(`LD ${register}, nn`, register).resolve(dw, context)
                    ...
                    return new Update8BitRegisterInstructionHandler(`LD ${register}, n`, register).resolve(dw, context)
                }
                break
            }
            case 0b01: { // 0x4-0x7
                if((register = this.targetRegister(n))) {
                    ...
                    context.clearRegisterValue(register)
                    return new DecomposedInstruction(`LD ${register}, (HL)`)
