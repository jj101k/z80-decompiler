    ...
    get simpleOpcodes() {
        return {
            ...
            [0x10]: new RelCondJumpInstructionHandler("DJNZ e").withAction((dw, context) => {
                ...
                context.storeRegisterValue(Z80Registers8B.A, 0)
            }),
        ...
        switch(n.pre) {
            case 0b00: { // 0x0-0x3
                ...
                if(n.b4 == 0b0001) { // 0x01 11 [21] 31
                    ...
                    if(n.b4 in arithmeticOpR) {
                        const v = context.getRegisterValue(rp)
                        if(v !== null) {
                            if(n.b4 & 0b1000) {
                                // Dec
                                context.storeRegisterValue(rp, v - 1)
                            } else {
                                context.storeRegisterValue(rp, v + 1)
                            }
                        }
            ...
            case 0b01: { // 0x4-0x7
                if((register = this.targetRegister(n))) {
                    const activeHLValue = context.getRegisterValue(Z80Registers16B.HL)
                    if(activeHLValue) {
            ...
            case 0b10: { // 0x8-0xb
                ...
                context.updateRegisterValue(Z80Registers8B.A, op, context.getValue(r))
            ...
            case 0b11: { // 0xc-0xf
                ...
                switch(n.b3) {
                    ...
                    case 0b110: {
                        ...
                        context.updateRegisterValue(Z80Registers8B.A, op, +di.arguments[0])
                        return di
                    }
                }
                break
