...
export class Initial extends InstructionHandler {
    ...
    get simpleOpcodes() {
        return {
            ...
            [0x0a]: new IndirectLoadInstructionHandler("A", "BC"),
            ...
            [0x1a]: new IndirectLoadInstructionHandler("A", "DE"),
        ...
        switch(n.pre) {
            ...
            case 0b01: { // 0x4-0x7
                if((register = this.targetRegister(n))) {
                    ...
                    return new IndirectLoadInstructionHandler(register, "HL").resolve(dw, context)
