...
export class Initial extends InstructionHandler {
    ...
    get simpleOpcodes() {
        return {
            ...
            [0x0a]: new ImportRegisterInstructionHandler("LD A, (BC)", "A"),
            ...
            [0x1a]: new ImportRegisterInstructionHandler("LD A, (DE)", "A"),
            [0x1f]: new TrivialInstructionHandler("RRA"),
            [0x20]: new RelCondJumpInstructionHandler("JR NZ, e"),
            [0x21]: new UpdateRegisterInstructionHandler("LD HL, nn", "HL"),
            ...
            [0x31]: new UpdateRegisterInstructionHandler("LD SP, nn", "SP"),
            ...
            [0x3a]: new LoadInstructionHandler("LD A, (nn)", "A"),
            ...
            [0xdd]: new DD(),
            [0xe1]: new ImportRegisterInstructionHandler("POP HL", "HL"),
            ...
            [0xf9]: new CopyRegisterInstructionHandler("SP", "HL"),
        ...
        switch(n.pre) {
            ...
            case 0b01: { // 0x4-0x7
                if((register = this.targetRegister(n))) {
                    ...
                    return new ImportRegisterInstructionHandler(`LD ${register}, (HL)`, register).resolve(dw, context)
            ...
            case 0b10: { // 0x8-0xb
                ...
                context.storeRegisterValue("A", context.getOpResult(op, context.getRegisterValue("A"), context.getValue(r)))
            ...
            case 0b11: { // 0xc-0xf
                ...
                switch(n.b3) {
                    ...
                    case 0b110: {
                        ...
                        context.storeRegisterValue("A", context.getOpResult(op, context.getRegisterValue("A"), +di.arguments[0]))
                        return di
                    }
                }
                break
