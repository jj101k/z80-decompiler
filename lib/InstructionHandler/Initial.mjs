...
export class Initial extends InstructionHandler {
    ...
    get simpleOpcodes() {
        return {
            ...
            [0x21]: new UpdateMemoryRegisterInstructionHandler("LD HL, nn"),
            ...
            [0x31]: new UpdateMemoryRegisterInstructionHandler("LD SP, nn"),
            ...
            [0xdd]: new DD(),
            [0xe1]: new CustomInstructionHandler("POP HL", (dw, context) => {
            ...
            [0xf9]: new TrivialInstructionHandler("LD SP, HL"),
