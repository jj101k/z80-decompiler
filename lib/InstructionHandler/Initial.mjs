    ...
    get(dw, context) {
        ...
        switch(n.pre) {
            ...
            case 0b10: { // 0x8-0xb
                ...
                context.storeRegisterValue(Z80Registers8B.A, context.getOpResult(op, context.getRegisterValue(Z80Registers8B.A), context.getValue(r)))
            ...
            case 0b11: { // 0xc-0xf
                ...
                switch(n.b3) {
                    ...
                    case 0b110: {
                        ...
                        context.storeRegisterValue(Z80Registers8B.A, context.getOpResult(op, context.getRegisterValue(Z80Registers8B.A), +di.arguments[0]))
                        return di
                    }
                }
                break
