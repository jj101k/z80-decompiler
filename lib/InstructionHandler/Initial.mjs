    ...
    get simpleOpcodes() {
        return {
            ...
            [0x10]: new RelCondJumpInstructionHandler("DJNZ e").withAction((dw, context) => {
                ...
                context.state.storeRegisterValue(Z80Registers8B.A, 0)
            }),
            ...
            [0x22]: new SaveInstructionHandler("LD (nn), HL", Z80Registers16B.HL, 2),
            ...
            [0x32]: new SaveInstructionHandler("LD (nn), A", Z80Registers8B.A, 1),
            ...
            [0x3a]: new LoadInstructionHandler("LD A, (nn)", Z80Registers8B.A, 1),
        ...
        switch(n.pre) {
            case 0b00: { // 0x0-0x3
                ...
                if(n.b4 == 0b0001) { // 0x01 11 [21] 31
                    ...
                    if(n.b4 in arithmeticOpR) {
                        const v = context.state.getRegisterValue(rp)
                        if(v !== null) {
                            if(n.b4 & 0b1000) {
                                // Dec
                                context.state.storeRegisterValue(rp, v - 1)
                            } else {
                                context.state.storeRegisterValue(rp, v + 1)
                            }
                        }
            ...
            case 0b01: { // 0x4-0x7
                if((register = this.targetRegister(n))) {
                    const activeHLValue = context.state.getRegisterValue(Z80Registers16B.HL)
                    if(activeHLValue) {
            ...
            case 0b10: { // 0x8-0xb
                ...
                context.state.updateRegisterValue(Z80Registers8B.A, op, context.state.getValue(r))
            ...
            case 0b11: { // 0xc-0xf
                ...
                switch(n.b3) {
                    ...
                    case 0b110: {
                        ...
                        context.state.updateRegisterValue(Z80Registers8B.A, op, +di.arguments[0])
                        return di
                    }
                }
                break
