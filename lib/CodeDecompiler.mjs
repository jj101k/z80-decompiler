...
import { ParsingInstructionHandler } from "./InstructionHandler/ParsingInstructionHandler.mjs"
 ...
 */
export const arOpR = {
    [0b000]: new BinaryOperator("ADD", (a, b) => a + b),
    [0b001]: new BinaryOperator("ADC", (a, b) => a + b),
    [0b010]: new BinaryOperator("SUB", (a, b) => a - b, () => 0),
    [0b011]: new BinaryOperator("SBC", (a, b) => a - b, () => 0),
...
export const addHlIxIy = (nx, reg) => {
    if(nx.b4 == 0b1001) {
        ...
        return new ParsingInstructionHandler(`ADD ${reg}, ${r}`, (dw, context) => {
