...
/**
 * @type {Record<number, {name: string, update?: (a: number, b: number) => number}>}
 */
export const arOpR = {
    [0b000]: {name: "ADD", update: (a, b) => (a + b) & 0xff},
    [0b001]: {name: "ADC", update: (a, b) => (a + b) & 0xff},
    [0b010]: {name: "SUB", update: (a, b) => (256 + a - b) & 0xff},
    [0b011]: {name: "SBC", update: (a, b) => (256 + a - b) & 0xff},
